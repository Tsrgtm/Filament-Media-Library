...
return [
    ...
    */
    ...
    |
    */
    'max_file_size' => env('MEDIA_LIBRARY_MAX_FILE_SIZE', 524288000), // 500MB
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Paths to ffmpeg and ffprobe binaries on the server.
    |
    | For Windows: 'C:\\ffmpeg\\bin\\ffmpeg.exe'
    | For Linux/Mac: '/usr/bin/ffmpeg' or 'ffmpeg'
    |
    */
    'ffmpeg' => [
        'ffmpeg_path' => env('MEDIA_LIBRARY_FFMPEG_PATH', 'ffmpeg'),
        'ffprobe_path' => env('MEDIA_LIBRARY_FFPROBE_PATH', 'ffprobe'),
    ],
];
